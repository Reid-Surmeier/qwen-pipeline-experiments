...
assert np.array_equal(source[:,:,:3],np.array(normalized.crop((20,16,1744,1440))))
checks=[]
...
result={'status':'pass','source':'reference/window-screenshot.png','working_color_space':'sRGB','rendered_reference_checks':checks,'preserved_native_corner_pixels':True,'resizing_preserves_header_title_and_corners':True}
